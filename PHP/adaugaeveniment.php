<!-- Pagină de adăugat un eveniment nou -->
...
<body>
	...
	<!-- Formularul de adăugat eveniment -->
	
	<div class = "row justify-content-center">
		<form action = "procesareevenimente.php" method="POST">
			<div class="form-group">
				<label>Nume Eveniment</label>
				<input type="text" name="Nume_Eveniment" class="form-control" placeholder="Numele evenimentului">
			</div>
			<div class="form-group">
